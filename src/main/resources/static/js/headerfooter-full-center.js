...
function prependHeaderSection() {
    ...
    var header = "<header>" +
        ...
        "<div class='bigd-collapse bigd-navbar-collapse bigd-navbar-right' id='bigd-coll'>" +
        ...
        "<li><a href='https://ngdc.cncb.ac.cn/sso'>Sign in</a></li>" +
        "</ul>" +
...
function appendFooterSection() {
    ...
    var footer = "" +
        ...
        "<a href='" + bigd_site + "'><img src='https://ngdc.cncb.ac.cn/cdn/image/CNCB-NGDC.png'  style='margin-top: 15px; margin-right: 10px'/></a> " +
        ...
        "<li><a href='http://www.picb.ac.cn/picben' target='_blank'><img src='" + bigd_site + "cdn/image/picb.png' style='height: 32px;'></a></li>" +
